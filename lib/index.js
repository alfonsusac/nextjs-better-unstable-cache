...
function memoize(cb, opts) {
    ...
    var cachedFn = (0, react_1.cache)(function () {
        var args = [];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        time = audit.getSec();
                        isSame = oldData === data;
                        console.log("".concat(chalk_1.default.hex('#AA7ADB').bold("Data Cache"), " - ") +
                            "".concat(cb.name, " ").concat(chalk_1.default.hex('#AA7ADB').bold(dataCacheMiss_1 ? "MISS" : "HIT"), " ") +
                            "".concat(chalk_1.default.hex('A0AFBF')(time.toPrecision(3) + 's'), " ") +
                            "".concat(chalk_1.default.hex('#AA7ADB').bold(dataCacheMiss_1 ? isSame ? 'background-revalidation' : 'on-demand revalidation' : ""), " ") +
                            '');
                        oldData = data;
                        return [2 /*return*/, data];
                    case 2: return [4 /*yield*/, (0, cache_1.unstable_cache)(function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                return [2 /*return*/, cb.apply(void 0, args)];
                            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        time = audit2.getSec();
                        console.log("".concat(chalk_1.default.hex('#FFB713').bold("Memoization"), " - ") +
                            "".concat(cb.name, " ").concat(chalk_1.default.hex('#FFC94E').bold(renderCacheHit ? "MISS" : "HIT"), " ") +
                            "".concat(chalk_1.default.hex('A0AFBF')(time.toPrecision(3) + 's'), " ") +
                            '');
                        renderCacheHit = false;
                        return [2 /*return*/, data];
