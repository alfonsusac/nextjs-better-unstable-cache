...
export function memoize(cb, opts) {
    ...
    var logVerbose = log.includes('verbose');
    var logID = (opts === null || opts === void 0 ? void 0 : opts.logid) ? "".concat(opts.logid, " ") : '';
    var oldData;
    var renderCacheHit;
    ...
    var cachedFn = cache(function () {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            var additionalCacheKey, revalidateTags, cacheKey, nextOpts, dataCacheMiss_1, audit, data, time, isSame, data;
            var _this = this;
            var _a;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        additionalCacheKey = additionalCacheKeyFn ?
                            typeof additionalCacheKeyFn === 'function' ? additionalCacheKeyFn.apply(void 0, args) : additionalCacheKeyFn
                            : [];
                        revalidateTags = revalidateTagsFn ?
                            typeof revalidateTagsFn === 'function' ? revalidateTagsFn.apply(void 0, args) : revalidateTagsFn
                            : [];
